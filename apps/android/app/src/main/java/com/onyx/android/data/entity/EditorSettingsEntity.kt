...
data class EditorSettingsEntity(
    ...
    val penMinWidthFactor: Float = 0.15f,
    val penMaxWidthFactor: Float = 2.5f,
    val penSmoothingLevel: Float = 0.5f,
    val penEndTaperStrength: Float = 0.6f,
    val penLineStyle: String = "SOLID",
    val highlighterTool: String = "HIGHLIGHTER",
    val highlighterColor: String = "#B31E88E5",
    val highlighterBaseWidth: Float = 6.5f,
    val highlighterMinWidthFactor: Float = 0.7f,
    val highlighterMaxWidthFactor: Float = 1.3f,
    val highlighterSmoothingLevel: Float = 0.5f,
    val highlighterEndTaperStrength: Float = 0.0f,
    val highlighterLineStyle: String = "SOLID",
