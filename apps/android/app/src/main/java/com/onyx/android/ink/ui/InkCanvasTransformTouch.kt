...
private fun endPanVelocityTracking(
    ...
    if (tracker != null && fling) {
        ...
        // OPTIMIZATION: Avoid expensive hypot() and type casting in touch hot loop
        val velocitySquared = velocityX * velocityX + velocityY * velocityY
        val minVelocitySquared = PAN_FLING_MIN_VELOCITY_PX_PER_SECOND * PAN_FLING_MIN_VELOCITY_PX_PER_SECOND
        if (velocitySquared >= minVelocitySquared) {
