...
private fun endPanVelocityTracking(
    ...
    if (tracker != null && fling) {
        ...
        // Performance optimization: Avoid hypot() overhead in hot tracking loops
        // since velocity values fit safely within Float limits.
...
private fun readTwoPointerTransform(event: MotionEvent): TwoPointerTransform? {
    ...
    // Performance optimization: Avoid hypot() overhead in hot tracking loops
    // since screen coordinates fit safely within Float limits.
