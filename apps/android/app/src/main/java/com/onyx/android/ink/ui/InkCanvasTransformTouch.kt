...
private fun endPanVelocityTracking(
    ...
    if (tracker != null && fling) {
        ...
        // ⚡ Bolt: Use squared distance comparison to avoid expensive Double cast and hypot overhead
...
private fun readTwoPointerTransform(event: MotionEvent): TwoPointerTransform? {
    ...
    val dx = x1 - x0
    val dy = y1 - y0
    // ⚡ Bolt: Use direct Float sqrt instead of hypot to avoid Double casting and overflow checks
