...
private const val PAN_FLING_MIN_VELOCITY_SQUARED_PX_PER_SECOND = PAN_FLING_MIN_VELOCITY_PX_PER_SECOND * PAN_FLING_MIN_VELOCITY_PX_PER_SECOND
...
private fun endPanVelocityTracking(
    ...
    if (tracker != null && fling) {
        ...
        if ((velocityX * velocityX + velocityY * velocityY) >= PAN_FLING_MIN_VELOCITY_SQUARED_PX_PER_SECOND) {
