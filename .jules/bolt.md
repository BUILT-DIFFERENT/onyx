...
## 2026-03-21 - Optimize hypot calls in touch loops
**Learning:** In performance-critical hot loops (e.g., canvas geometry calculations, erasing logic, touch gesture velocity tracking), avoid expensive math operations like hypot (which carries overflow/underflow checking and scaling overhead).
**Action:** Use mathematically equivalent optimizations like comparing squared distances or manually computing sqrt(dx*dx + dy*dy) directly on Floats to avoid unnecessary type casting.
